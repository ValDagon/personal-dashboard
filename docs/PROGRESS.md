...
| 2026-08-25 | **Сейчас = зелёный.** Статус `now` на графике `#3DFF8A`. |
| 2026-08-25 | **HUD palette.** Статус-чарт: cyan / amber / pink, без серого. |
| 2026-08-25 | **«Падения» localhost = SIGTERM агента.** Логи без traceback. Фикс: `scripts/serve.py` (новая сессия, не LaunchAgent). |
| 2026-08-25 | **swift-agent на доске.** Хобби, личный open-source (не фриланс). GitHub в ссылках. |
